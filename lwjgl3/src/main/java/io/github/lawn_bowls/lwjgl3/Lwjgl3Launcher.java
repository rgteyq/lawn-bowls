package io.github.lawn_bowls.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import io.github.lawn_bowls.Main;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("LawnBowls");
        ...
        // Matches a typical Android/iPhone portrait screen (~2.2:1), e.g. Pixel 7 (412x915) /
        // iPhone 14 (390x844) logical points — the previous 220x1000 was far taller/narrower
        // than any real phone.
        configuration.setWindowedMode(412, 915);
